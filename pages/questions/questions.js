...
Page({
  data: {
    ...
    questions: [
      ...
      { id: 8, category: '功能', question: '在哪里能看到已经下载/解析过的视频？', answer: '打开MiniParse首页，点击底部「我的」进入个人中心，在「我的解析记录」里就能看到所有解析、下载过的视频，还能按时间排序查找。', showAnswer: false },
  ...
  onShareAppMessage() {
    return {
      title: 'MiniParse使用指南：解决解析失败、保存失败等常见问题',
