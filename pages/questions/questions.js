  ...
  data: {
    questions: [
      ...
      },
      {
        ...
        answer: "打开MiniParse首页，点击底部「我的」进入个人中心，在「历史记录」里就能看到所有解析、下载过的视频，还能按时间排序查找。",
        showAnswer: false
      },
      {
        id: 8,
      ...
      },
      {
        ...
        answer: "简单2步就能修复：① 关闭MiniParse小程序（在微信「最近使用的小程序」里删掉）；② 重新打开MiniParse，大部分卡顿/错乱问题都会解决。如果还不行，建议重启微信再试。",
        showAnswer: false
      },
      {
        id: 11,
