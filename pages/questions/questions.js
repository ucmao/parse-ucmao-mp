...
Page({
  data: {
    ...
    navBarHeight: 44,
    questions: [
      { id: 1, category: '其他', question: '免责声明与服务公约', answer: 'MiniParse 作为中立的技术服务提供者，帮助用户学习与素材赏析。请合法使用，避免侵权；本程序不存储视频，版权归原平台及作者所有。MiniParse 致力于维护健康、积极的网络环境，适用于所有功能。', showAnswer: false },
      ...
      { id: 8, category: '功能', question: '在哪里能看到已经下载/解析过的视频？', answer: '打开 MiniParse 首页，点击底部「我的」进入个人中心，在「我的解析记录」里即可查看所有已解析、下载的视频，并可按时间排序。', showAnswer: false },
      ...
      { id: 11, category: '技术', question: '小程序运行卡顿、界面错乱，怎么解决？', answer: '简单2步即可修复：① 关闭 MiniParse 小程序（在微信「最近使用的小程序」里删除）；② 重新打开 MiniParse，通常可解决卡顿或错乱。如仍有问题，建议重启微信后再试。', showAnswer: false },
  ...
  onShareAppMessage() {
    return {
      title: 'MiniParse 使用指南：解决解析失败、保存失败等常见问题',
